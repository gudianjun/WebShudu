 ...
 */
export declare class FlexChartBase<T = any> extends Control implements _IPalette {
 ...
 */
export declare class SeriesBase<T = any> implements _ISeries {
