...
export declare class GridPanel {
    ...
    _getSpecialData(r: number, row: Row, c: number, col: Column, bindingCol: any, isGroupRow: boolean, group: CollectionViewGroup): any;
    /**
...
export declare const colHdrAriaAttributes: (cell: HTMLElement, col: Column, gridPanel: GridPanel, g: FlexGrid<any>, isRowHeader?: boolean) => void;
/**
 ...
 */
export declare enum GroupSummaryPosition {
 ...
 */
export declare class FlexGrid<T = any> extends Control {
    ...
    protected _cv: ICollectionView<T>;
    ...
    */
     ...
     */
    readonly editableCollectionView: IEditableCollectionView<T>;
    /**
